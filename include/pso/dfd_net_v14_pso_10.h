...
extern const std::string version = "pso_10_49_";
extern const std::vector<std::pair<uint64_t, uint64_t>> crop_sizes = {{36, 36}, {368, 400}};
extern const uint64_t num_crops = 20;
