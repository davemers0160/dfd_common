...
do_1 = Slider(title="focus point 1 (m):", start=1, end=20000, step=1, value=309, width=1500, callback_policy="mouseup", callback_throttle=50)
do_2 = Slider(title="focus point 2 (m):", start=1, end=20000, step=1, value=10000, width=1500, callback_policy="mouseup")
